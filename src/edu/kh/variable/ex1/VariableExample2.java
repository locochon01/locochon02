...
public class VariableExample2 {
	public static void main (String [] args) {
		...
		boolean booleanData;
		// 메모리에 논리 값 (t/f)을 저장할 공간 1byte할당하고
		...
		// 정수 자료형의 기본형! (short, byte 옛날 코드에 잔재)
		int intNumber = 2147483647; // 변수 선언 및 초기화
		// 자료형 변수명 = 리터럴;
		//프로그램밍에서는 대입되는 데이터를 리터럴이라는 단어로도 표현
		
		//**리터럴 : 변수에 대입되거나 작성되는 값 자체
		// + 자료형에 따라 리터럴 표기법이 다름.
		
		long longNumber = 10000000000L; // long을 쓸 경우 끝에 L (대문자 소문자 무관) 써야함
		//the literal 10000000000 of type int is out of range
		//100억이라는 값은 범위를 벗어남
		//뒤에 L을 붙여줌으로써 long 자료형인것을 나타냄
		
		//실수형
		float floatNumber = 1.2345f; // float 사용시 끝에 F (대문자 소문자 무관 써야함)
		 ...
		 * ---> 반대로 생각하면 범수에 애초에 66이라는 숫자를 저장하는 것이 가능.
		 */
		
		//변수 명명 규칙
		//1. 대소문가 구분 O, 길이제한 X
		
		int afjpaifjapoisdjfapodfjiapfjaiodjfpo;
		int afjpaifjapoisdjfapodfjiapfjaiodjfpO;
		...
		//4. 특수문자는 _ 와 $ 만 사용 가능 (하지만 쓰지 않는다)
		
		int $intNumber; // 문제는 없지만 개발자가 직접 사용 안합니다
		int int_number; // 자바는 카멜표기법을 쓰기 때문에, _ 작성 안 함
						// _ 작성표기법은 DB에서 사용
		 ...
		 * 
		 * - 상수 명명 규칙: 모두 대문자, 여러 단어 합성 시 _ 사용
		 * 
		 * - 상수를 사용하는 경우
